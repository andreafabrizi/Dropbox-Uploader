...
#Account test
db_test() {
  local temp_file=/tmp/dropbox_uploader_test_file
  touch "${temp_file}"
  echo "This is a dropbox_uploader test file" >${temp_file}
  echo ""
  echo "Test file uploading ..."
  db_upload /tmp/dropbox_uploader_test_file /dropbox_uploader/dropbox_uploader_test_file
  get_status_message $?
  echo ""
  echo "Test file sharing ..."
  db_share /dropbox_uploader/dropbox_uploader_test_file
  get_status_message $?
  echo ""
  echo "Test file deleting ..."
  db_delete /dropbox_uploader/dropbox_uploader_test_file
  get_status_message $?
  echo ""
  echo -ne "Removing local test file ...\n"
...
#NEW SETUP...
  ...
  # Test dropbox account for upload, share and delete to work with this script
  db_test
