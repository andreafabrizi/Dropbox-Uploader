...
if [ "$DROPBOX_UPLOADER" ]; then
    APPKEY=$DROPBOX_UPLOADER_APPKEY
    APPSECRET=$DROPBOX_UPLOADER_APPSECRET
    ACCESS_LEVEL=$DROPBOX_UPLOADER_ACCESS_LEVEL
    OAUTH_ACCESS_TOKEN=$DROPBOX_UPLOADER_OAUTH_ACCESS_TOKEN
    OAUTH_ACCESS_TOKEN_SECRET=$DROPBOX_UPLOADER_OAUTH_ACCESS_TOKEN_SECRET
